...
function Task() {
  ...
  useEffect(() => {
    if (!isAddTaskModalOpen || isRenderChange) {
      axios
        .get(
          `https://project-management-api-4mjg.onrender.com/project/${projectId}`
        )
        .then((res) => {
  ...
  const updateTodo = (data) => {
    axios
      .put(
        `https://project-management-api-4mjg.onrender.com/project/${projectId}/todo`,
        data
      )
      .then((res) => {})
      .catch((error) => {
  ...
  const handleDelete = (e, taskId) => {
    ...
    axios
      .delete(
        `https://project-management-api-4mjg.onrender.com/project/${projectId}/task/${taskId}`
      )
      .then((res) => {
